...
@section('content')
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
               <form class="form-horizontal form-label-left" action="{{ route('hijo.store') }}" method="post" autocomplete="off">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="hidden" name="personal" id="personal" class="form-control" value="{{$complementoPersonal->id}}">
                        </div>   
                </div>
