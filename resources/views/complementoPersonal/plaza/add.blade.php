...
@section('content')
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
               <form class="form-horizontal form-label-left" action="{{ route('plaza.store') }}" method="post" autocomplete="off">
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="text" name="descripcion" id="descripcion" class="form-control" required="required" placeholder="Descripcion">
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="text" name="tipoMov" id="tipoMov" class="form-control" required="required" placeholder="Tipo de Movimiento">
                        </div>
                    </div>
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="text" name="Diagonal" id="Diagonal" class="form-control" required="required" placeholder="Diagonal">
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="text" name="horasNombramiento" id="horasNombramiento" class="form-control" required="required" placeholder="Horas de Nombramiento">
                        </div>
                    </div>
