...
@section('content')
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
               <form class="form-horizontal form-label-left" action="{{ route('contacto.store') }}" method="post" autocomplete="off">
                ...
                <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="hidden" name="ingreso" id="ingreso" class="form-control" value="{{$rht_ingreso->id}}">
                        </div>   
                </div>
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="number" name="numero" id="numero" class="form-control" required="required" placeholder="Numero">
                        </div>   
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="text" name="codigoPostal" id="codigoPostal" class="form-control" required="required" placeholder="Codigo Postal">
                        </div>   
                    </div>                    
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="text" name="colonia" id="colonia" class="form-control" required="required" placeholder="Colonia">
                        </div>   
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="text" name="celular" id="celular" class="form-control" required="required" placeholder="Celular">
                        </div>   
                    </div>
