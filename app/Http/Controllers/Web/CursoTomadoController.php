...
class CursoTomadoController extends Controller
{
    /**
    ...
    {
        return view('curriculum.cursoTomado.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        $constancia ="constanciaCT".rand().$tarjeta.'.'.$file->getClientOriginalExtension();
        $subir = $file ->move($destinoPath,$constancia);
       
        $cursoTomado=cursoTomado::create([
            'año' => $request['año'],
    ...
    {
        return view('curriculum.cursoTomado.add',compact('id'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(cursoTomado $cursoTomado)
    {
        return view('curriculum.cursoTomado.edit', compact('cursoTomado'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
        public function update(Request $request, cursoTomado $cursoTomado)
    {
        $id_p= $cursoTomado->personal;
        $tarjeta=complementoPersonal::where('id', '=', $id_p)->value('personal');
        ...
        DB::table('rht_cursoTomado')->update([
            'año' => $request['año'],
            'nombre' => $request['nombre'],
            'modalidad' => $request['modalidad'],
            'duraciónHrs' => $request['duracionHrs'],
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(cursoTomado $cursoTomado)
    {
        $id_p= $cursoTomado->personal;
        $cursoTomado->delete();
        $id_i=complementoPersonal::where('id', '=', $id_p)->value('ingreso');
