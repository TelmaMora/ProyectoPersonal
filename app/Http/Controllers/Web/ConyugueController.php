...
class ConyugueController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('complementoPersonal.index',compact('contactos','ingresos','conyugues'));
    }
    ...
    {
        return view('complementoPersonal.conyugue.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        $conyugue=conyugue::create($request->all());
        ...
        //return redirect()->route('complementoPersonal.add')->with('message','SE REGISTRO CORRECTAMENTE');
    }
    ...
    {
        return view('complementoPersonal.conyugue.edit', compact('conyugue'));
    }
   ...
   public function update(Request $request, conyugue $conyugue)
    {
        $id_p= $conyugue->personal;
        $conyugue->update($request->all());
        $id_i=complementoPersonal::where('id', '=', $id_p)->value('ingreso');
        $id_c=complementoPersonal::where('id', '=', $id_p)->value('contacto');
        $complementoPersonal=complementoPersonal::where('id', '=', $id_p)->get();
        $personal=rht_personal::all();
    ...
    {
        $conyugue->delete();
        return redirect()->route('conyugue.index')->with('message','SE ELIMINO CORRECTAMENTE');
    }
}
